...
export default function InvoiceDetailsPage() {
  ...
  const getStatusIcon = (status: string) => {
    ...
    switch (status) {
      ...
      case 'pending':
        return <ClockIcon style={{ ...iconStyle, color: '#eab308' }} />; // yellow-500
      case 'overdue':
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KPICard
            ...
            icon={overpaymentAmount > 0 ? 
              <CurrencyDollarIcon style={{ height: '24px', width: '24px', color: '#22c55e' }} /> : 
              <ClockIcon style={{ height: '24px', width: '24px', color: '#f97316' }} />
            }
          />
          {overpaymentAmount > 0 && (
            <button
            ...
            >
              <div className="flex items-center gap-2">
                <CurrencyDollarIcon style={{ height: '20px', width: '20px', color: '#ca8a04' }} />
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div 
                      ...
                      style={{
                        color: (invoice.paidAmount || 0) >= (invoice.total || 0) 
                          ? '#16a34a'  // green-600
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
              ...
              <div className="mb-6 space-y-4">
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm" style={{ color: '#166534' }}>Available Credit:</span>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <CheckCircleIcon style={{ height: '24px', width: '24px', color: '#22c55e' }} className="flex-shrink-0" />
                      <div>
