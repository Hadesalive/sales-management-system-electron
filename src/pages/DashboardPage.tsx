        ...
        >
          <div className="flex flex-col items-center justify-center h-full space-y-4">
            ...
            <div className="text-center px-4">
              ...
              <div 
                className={`text-xl font-bold tracking-wide ${calculateMonthlyProfit(salesData, productsData) >= 0 ? 'text-green-600' : 'text-red-600'}`}
                style={{ letterSpacing: '0.5px' }}
              >
                {calculateMonthlyProfit(salesData, productsData) >= 0 ? '+' : ''}
                {formatCurrency(calculateMonthlyProfit(salesData, productsData))}
              </div>
